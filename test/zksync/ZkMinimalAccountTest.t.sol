...
contract ZkMinimalAccountTest is Test {
    ...
    function testPayForTransaction_RevertsOnFailure() public {
        // Arrange
        Transaction memory transaction =
            _createUnsignedTransaction(minimalAccount.owner(), 113, BOOTLOADER_FORMAL_ADDRESS, 0, "0x");
        transaction = _signTransaction(transaction);

        // Act and Assert
        vm.prank(BOOTLOADER_FORMAL_ADDRESS);
        // vm.expectRevert(ZkMinimalAccount__FailedToPay.selector);
        // minimalAccount.payForTransaction(EMPTY_BYTES32, EMPTY_BYTES32, transaction);
    }
